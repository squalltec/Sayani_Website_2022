...
$country='https://en.wikipedia.org/wiki/United_Arab_Emirates';
	$ch = curl_init();
...
echo $aa[3]->children(0)->plaintext;
	...
	$html2->load($response2);
			...
			$cities='https://en.wikipedia.org/wiki/List_of_airports_in_the_United_Arab_Emirates';
	$ch22 = curl_init();
	curl_setopt($ch22, CURLOPT_URL, $cities);
	...
	$html22->load($response22);
			...
			$citys='https://www.trip.com/travel-guide/search/?keyword=dubai';
	$ch223 = curl_init();
